...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen w-full relative bg-white overflow-hidden flex flex-col items-center justify-center px-6">
      {/* Top Right Teal Glow */}
      <div
      ...
      <div
        ...
        style={{
          backgroundImage: `
            radial-gradient(circle at bottom left, rgba(128, 90, 230, 0.3), transparent 70%)
          `,
          filter: "blur(120px)",
          backgroundRepeat: "no-repeat",
        }}
...
>
  <a
    ...
    className="text-gray-700 hover:text-gray-900 transition-colors duration-300 text-2xl"
    title="GitHub"
  >
    <FaGithub />
  </a>
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="text-teal-500 hover:text-teal-700 transition-colors duration-300 text-2xl"
    ...
    <FaBook />
      ...
      >
        <button
          ...
          className="bg-teal-500 text-white font-semibold px-8 py-4 rounded-xl shadow-lg hover:bg-teal-600 transition-colors duration-300 text-lg"
        >
          Get Started
        </button>
      </motion.div>
